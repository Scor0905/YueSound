 ...
 * 2022-07-29T15:15:22.779+08:00
 * Generated source version: 2.4.2
 * 
 */
@WebServiceClient(name = "IKmReviewWebserviceServiceService", 
                  wsdlLocation = "http://192.168.2.220/sys/webservice/kmReviewWebserviceService?wsdl",
...
public class IKmReviewWebserviceServiceService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://192.168.2.220/sys/webservice/kmReviewWebserviceService?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(IKmReviewWebserviceServiceService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://192.168.2.220/sys/webservice/kmReviewWebserviceService?wsdl");
        }
        WSDL_LOCATION = url;
    }
