package com.local.entity.entity;

import java.io.Serializable;

/**
 * 物料分类自定义项(ProductManagementClassDefine)实体类
 *
 * @author makejava
 * @since 2022-07-29 10:35:53
 */
public class ProductManagementClassDefine implements Serializable {
    private static final long serialVersionUID = 994151932711873291L;
    /**
     * 物料分类ID
     */
    private Long id;
