...
/**
 * (AgentcategoryDefine)实体类
 *
 * @author makejava
 * @since 2022-07-29 11:30:28
 */
public class AgentcategoryDefine implements Serializable {
    private static final long serialVersionUID = 327106730639964163L;
    /**
     * 客户分类ID
     */
    private Long id;
