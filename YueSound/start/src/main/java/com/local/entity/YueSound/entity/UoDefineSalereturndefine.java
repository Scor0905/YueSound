...
/**
 * (UoDefineSalereturndefine)实体类
 *
 * @author makejava
 * @since 2022-08-02 17:03:25
 */
public class UoDefineSalereturndefine implements Serializable {
    private static final long serialVersionUID = -58180406305715012L;

    private Long id;

    private Long iSaleReturnId;

    private String cSaleReturnNo;
    /**
     * 时间戳
     */
    private Date pubuts;
